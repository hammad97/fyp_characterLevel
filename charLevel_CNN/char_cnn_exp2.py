...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 28 15:00:26 2018

@author: characterleveldl
"""
...
embedding_size = 8
conv_layers = [[256, 7, 3],             #filter_num, filter_size, pooling_size
               [256, 7, 3],
               [256, 3, -1],
               [256, 3, -1],
               [256, 3, -1],
...
print(vocab_size)
embedding_weights = []  # (70, 8)
embedding_weights.append(np.zeros(8))  # (0, 69)

for char, i in tk.word_index.items():  # from index 1 to 69
    if (char != 'UNK'):
        val = format(ord(char), 'b')
    else:
        val = '11111111'
    if (len(val) == 7):
        val = '0' + val
